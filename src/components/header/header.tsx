...
export default function Header() {
    ...
    return (
        <div className="flex items-center justify-between lg:sticky top-0 left-0 w-full lg:px-[8%] z-[50] px-8 bg-white p-3 border border-transparent border-b-primary/[0.1]">
