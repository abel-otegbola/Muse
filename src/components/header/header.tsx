...
export default function Header() {
    ...
    return (
        <div className="flex items-center justify-between lg:sticky top-0 left-0 w-full lg:px-[8%] px-8 bg-white p-3 rounded-[8px] border border-transparent border-b-primary/[0.1]">
            ...
            <div className="md:flex items-center gap-6 xl:w-[40%] md:w-[35%] hidden">
